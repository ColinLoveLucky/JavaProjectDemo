...
@Service("BorrowerLoanPolicy")
public class ReviceBorrowerLoanPolicyImpl extends ReviceTask{
	
	private static final Logger LOGGER=LoggerFactory.getLogger(ReviceBorrowerLoanPolicyImpl.class);
